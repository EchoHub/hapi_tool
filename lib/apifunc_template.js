module.exports = function apiFuncTemplateFactory (funcName, path, options, server, mockData) {
    ...
    return ${server !== "mock"} ? (my.httpRequest || my.request)(options) : success(JSON.parse(${JSON.stringify(mockData || {})}))
}`
}