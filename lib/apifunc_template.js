module.exports = function apiFuncTemplateFactory (funcName, path, options, domain, mockData) {
    ...
    return ${domain !== "mock"} ? (my.httpRequest || my.request)(options) : success(JSON.parse(${JSON.stringify(mockData || {})}))
}`
}